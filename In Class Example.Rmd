...
n_total_sample = 3000 # Reduces data size for faster development
n_balance = 1000 # Balances data set, cannot be more than n_total_sample / number of classes. i.e. reviewer_recommended has "yes" and "no" (2 classes)
